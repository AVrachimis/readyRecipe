...
def populate():
    ...
    comments = {"110": [{"recommentations": "Really nice recipe, Congratulations", "owner": "AndyGr"},
                        ...
                        {"recommentations": "Any recommendations to reduce the calories of the meal?",
                         "owner": "GeorgeJr"},
                        ],
                "111": [{"recommentations": "Really nice recipe, except of the sauce at the top.", "owner": "AndyGr"},
                        ...
                        {
                            "recommentations": "I cooked it a little bit longer, added 3 tbsp red curry paste and it was surprisingly delicious!",
                            "owner": "GeorgeJr"},
                        ],
                ...
                "113": [{"recommentations": "Almost Perfect", "owner": "AndyGr"},
                        {
                            "recommentations": "I didn’t have any eggs, so I replaced them with a banana-chia-flaxseed pulse. It turned out terrible; this recipe is terrible.",
                            "owner": "Andrew"},
                        {"recommentations": "I cooked it a little bit longer, and it was surprisingly delicious!",
                         "owner": "GeorgeJr"},
                        ],
                "114": [{"recommentations": "Perfect medium rare steak", "owner": "AndyGr"},
                        {"recommentations": "The sauce is too sweet. Stronlgy recommend it without any sauce!!",
                         "owner": "Andrew"},
                        {"recommentations": "I cooked it a little bit longer but the taste it was still nice!",
                         "owner": "GeorgeJr"},
                        ],
                "115": [{"recommentations": "It could be better", "owner": "AndyGr"},
                        {"recommentations": "Really uncommon taste, not sure if I like it or not.",
                         "owner": "AdamSmith"},
                        ],
                ...
                "117": [{"recommentations": "Nice and juicy!!", "owner": "AndyGr"},
                        ...
                        {"recommentations": "I cooked it a little bit longer, byt it was still delicious.",
                         "owner": "GeorgeJr"},
                        ],
                ...
                "122": [{"recommentations": "Really nice recipe, Congratulations", "owner": "JohnBrown"},
                        {"recommentations": "Good texture and taste, i added some more pepper to make it better!!",
                         "owner": "Andrew"},
                        ],
                "125": [{"recommentations": "Can I use onion powder instead of onion??", "owner": "AndyGr"},
                        {
                            ...
                            "owner": "Andrew"},
                        {
                            "recommentations": "Simple and delicious!! I served this with a mozarella smoked chicken ravioli. Thank for the recipe",
                            "owner": "AdamSmith"},
                        ],
                "129": [
                    {"recommentations": "One of the best vegetarian dishes I ever tried!! thanks ", "owner": "AndyGr"},
                    ],
                "130": [
                    {"recommentations": "I made it with cod instead of salmon, still delicious", "owner": "JohnBrown"},
    ...
    for category, recipes in categories.items():
        ...
        for rec in recipes:
            ...
            new_recipe = add_recipe(rec['id'], rec['name'], rec['picture'], rec['ingredients'], rec['instructions'],
                                    rec['portions'], rec['difficulty'], rec['completion_time'], rec['calories'],
                                    rec['price'], cat, current_user)
            # create the comments
...
def add_recipe(id, name, picture, ingredients, instructions, portions, difficulty, time, calories, price, category,
               owner):
    recipe = \
    Recipe.objects.get_or_create(id=id, name=name, picture=picture, ingredients=ingredients, instuction=instructions,
                                 portions=portions, difficulty=difficulty, completion_time=time, calories=calories,
                                 average_overall_price=price, category_id=category, owner_id=owner)[0]
    recipe.save()
    return recipe
