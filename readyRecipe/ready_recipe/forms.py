...
from ready_recipe.models import Category,Recipe,Quantities,Comment,Ingredient,UserProfile
...
class RecipeForm(forms.ModelForm):
    ...
    picture = forms.ImageField(help_text = 'Photo ')
    ...
    class Meta:
        model = Recipe
        exclude = ('views','slug','owner_id','ingredient')
...
class CommentForm(forms.ModelForm):
    ...
    recommentations = forms.CharField(widget=forms.Textarea)
